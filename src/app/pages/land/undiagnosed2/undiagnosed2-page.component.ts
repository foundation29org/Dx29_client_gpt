...
@Component({
    selector: 'app-undiagnosed2-page',
    templateUrl: './undiagnosed2-page.component.html',
    styleUrls: ['./undiagnosed2-page.component.scss'],
    providers: [ApiDx29ServerService, jsPDFService],
})

export class Undiagnosed2PageComponent implements OnInit, OnDestroy {
    ...
    preparingCallOpenAi(step) {
        ...
        if (step == 'step3' || step == 'step4' || (step == 'step2' && this.showInputRecalculate && this.medicalText2.length > 0)) {
            if (this.optionSelected.id == 1) {
                ...
                console.log(this.medicalText2Copy)
                console.log(this.medicalText.indexOf(labelMoreSymptoms))
